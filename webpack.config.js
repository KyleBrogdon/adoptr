...
module.exports = {
    entry: {
        ...
        'scripts/siteAdmin/disposition': path.join(__dirname, "src", "siteAdmin", "disposition.js"),
        'scripts/siteAdmin/breed': path.join(__dirname, "src", "siteAdmin", "breed.js"),
        ...
        'scripts/user/petProfile': path.join(__dirname, "src","user", "petProfile.js"),
        ...
        'scripts/shelterAdmin/shelterList':path.join(__dirname,"src","shelterAdmin","shelterList.js"),
